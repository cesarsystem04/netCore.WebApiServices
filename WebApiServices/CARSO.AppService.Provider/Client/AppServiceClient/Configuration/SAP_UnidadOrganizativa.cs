...
namespace CARSO.AppService.Provider.Client
{
    public partial class AppServiceClient : ClientBase<IAppService>, IAppService
    {
        ...
        {
            return Channel.GetUnidadOrganizativaAll( ref oUnidadOrganizativaListResponse);
        }

        public DataResponse GetUnidadOrganizativaByKey( ref UnidadOrganizativa oUnidadOrganizativaListResponse)
        {
            return Channel.GetUnidadOrganizativaByKey( ref oUnidadOrganizativaListResponse);
        }
